...
?>
<br>
<div style="font-size:20px"><a href="./page_tool.php">粉絲團工具選單</a>
 <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>
 <a href="./page_tool_monitor.php">粉絲團社群監控</a></div>
<hr>
<form action="./page_tool_monitor.php" method="post" id="mform" class="form-horizontal">
<!--panel-group-->
...
<!--panel1-->
	...
	<br/>
	<div style="font-size:15px">目前設定:按讚數超過<?php  echo $like; ?>,且評論數超過<?php  echo $comment; ?>,且分享數超過<?php  echo $share; ?>,且文章顯示數量<?php  echo $post; ?>,  </div>
</form>
<!--form-->
...
*/
	...
	$query_str = "select id,page_id,message,likes,shares,comments from posts where (date between '".date("Y-m-01")."' and '".date("Y-m-d")."') AND page_id IN (";
